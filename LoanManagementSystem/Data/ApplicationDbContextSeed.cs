        ...
        public static async Task SeedIdentityUserAsync(UserManager<IdentityUser> usermanager)
        {
            ...
            if (user == null)
            {
                ...
                await usermanager.AddToRolesAsync(user, new string[] {
                    MyIdentityRoleNames.LoanAdmin.ToString(),
                    MyIdentityRoleNames.LoanMember.ToString()
                });
            }
            ...
            if (user == null)
            {
                ...
                //});
                await usermanager.AddToRoleAsync(user, MyIdentityRoleNames.LoanMember.ToString());
            }
        }
    }
}
